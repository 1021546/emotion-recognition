# each file(*.txt) divided into 7 fold by emotion , same emotion divided into same fold
import os
import types
...
emotion_pointer = [0, 1, 2, 3, 4, 5, 6] # seven emotions assigned to five fold
...
def five_part(inputData,inputName):
    global fold_pointer
    emotion_index = int(getEmotion(inputName[5]))
    fold_pointer = emotion_pointer[emotion_index-1]
    # fold_count[fold_pointer]
